    ...
    def corner_net(self, img, gt_tag_tl=None, gt_tag_br=None, is_training=True, scope='CornerNet'):
        with tf.variable_scope(scope):
            ...
            with tf.variable_scope('inter_supervise'):
                ...
                hourglass_1 = self.model.hourglass(start_layer, self.n_deep, self.n_res, self.n_dims,
                                                   is_training=is_training)  # [b,128,128,256]
            ...
            with tf.variable_scope('master_branch'):
                ...
                hourglass_2 = self.model.hourglass(inter, self.n_deep, self.n_res, self.n_dims,
                                                   is_training=is_training)  # [b,128,128,256]
            ...
            outs = [heat_tl_is, heat_br_is, tag_tl_is, tag_br_is, offset_tl_is, offset_br_is, heat_tl, heat_br, tag_tl,
                    tag_br, offset_tl, offset_br]
